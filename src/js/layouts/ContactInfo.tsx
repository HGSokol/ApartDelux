...
function ContactInfo() {
  ...
  return (
    <div id='contact' className="mx-auto w-[834rem] h-[540rem] border-[3rem] border-[#925E10] flex flex-col items-center justify-center mb-[147rem]">
      <div className='font1 font-[900] text-[68rem] leading-[102.14rem] text-white mb-[35rem]'>Свяжитесь с нами</div>
      <div className='mb-[81rem]'>
