		...
		<div
			...
			<div className="text-white">
				<div className="flex flex-row items-center lg:gap-[50rem] lg:mb-[24rem] mb-[25rem]">
					<div className="font-font1 font-[700] text-[44rem] leading-[42rem] lg:text-[60rem] lg:leading-[57rem]">
						Deluxe Apart{' '}
					</div>
					<div className="hidden lg:font-font1 lg:font-[700] lg:text-[60rem] lg:leading-[57rem] text-white">
						<svg
							width="56"
							height="1"
							viewBox="0 0 56 1"
				...
				<div className="lg:w-[550rem] mb-[43rem] lg:mb-0 font-font2 font-[400] text-[20rem] leading-[25rem] lg:text-[24rem] lg:leading-[30rem] text-[#C4C4C4]">
